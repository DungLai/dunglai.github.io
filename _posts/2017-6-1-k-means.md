...
desc : <div class="tag">Pascal</div></br> This algorithm gives labels to unlabeled datas and put them into group. 
...
- [5. Acknowledgement](#5-acknowledgement)
	- [Reference](#reference)
- [**6.Source Code and PDF report**](#6source-code-and-pdf-report)
...
<div class="imgcap">
<img style="float:left; display: inline-block; width: 50%;" src ="/public/post_img/Kmeans/compress1.png" width = "500" align = "center">
<img id="fig1" style="float:left; display: inline-block; width: 50%;" src ="/public/post_img/Kmeans/compress2.png" width = "500" align = "center">
...
<a name="6source-code-and-pdf-report"></a>
## **6.Source Code and PDF report**
...
<div class="imgcap">
<img style="float:left; display: inline-block; width: 50%;" src ="/public/post_img/Kmeans/kmean.PNG" width = "500" align = "center">
<img id="fig1" style="float:left; display: inline-block; width: 50%;" src ="/public/post_img/Kmeans/kmean1.PNG" width = "500" align = "center">
<div class="thecap">Program interface<br></div>
</div>
<div style="clear:left;"></div>

<a name="declare-data-types"></a>
### Declare Data types
```pascal
const
  POINT_RADIUS = 5;
