...
\BulletItem
\textbf{Software Engineer - Deakin Software and Technology Innovation Lab}
\hfill
\DatestampYMD{2018}{11}{15} -- now
\SubBulletItem Develops a virtual receptionist application that applies face detection and recognition algorithm.
\SubBulletItem Uses C\#, unity, python, flask, docker.

\BulletItem
\textbf{Tutor - Swinburne University of Technology}
\hfill
\DatestampYMD{2018}{7}{27} -- now
